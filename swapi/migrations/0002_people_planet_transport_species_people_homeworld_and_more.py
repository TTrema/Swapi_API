    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('homeworld', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='swapi.planet')),
                ('people', models.ManyToManyField(related_name='species', to='swapi.people')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('edited', models.DateTimeField(auto_now=True)),
                ('name', models.CharField(max_length=100)),
                ('homeworld', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='heroes', to='swapi.planet')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            name='Vehicle',
            fields=[
                ('transport_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='swapi.transport')),
                ('vehicle_class', models.CharField(max_length=40)),
                ('pilots', models.ManyToManyField(blank=True, related_name='vehicles', to='swapi.people')),
            ],
            options={
                'abstract': False,
            },
            bases=('swapi.transport',),
        ),
        migrations.CreateModel(
            name='Starship',
            fields=[
                ...
                ('pilots', models.ManyToManyField(blank=True, related_name='starships', to='swapi.people')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('characters', models.ManyToManyField(blank=True, related_name='films', to='swapi.people')),
                ('planets', models.ManyToManyField(blank=True, related_name='films', to='swapi.planet')),
                ('species', models.ManyToManyField(blank=True, related_name='films', to='swapi.species')),
                ('starships', models.ManyToManyField(blank=True, related_name='films', to='swapi.starship')),
                ('vehicles', models.ManyToManyField(blank=True, related_name='films', to='swapi.vehicle')),
            ],
            options={
                'abstract': False,
            },
